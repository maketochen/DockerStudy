...
namespace FakeTrave.API.Migrations
{
    ...
    [Migration("20210310154639_UpdateTourisRouteSchema")]
    partial class UpdateTourisRouteSchema
    {
            ...
            modelBuilder.Entity("FakeTrave.API.Models.TouristRoute", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("0587b51c-2187-4241-931d-502c34640a0e"),
                            CreateTime = new DateTime(2021, 3, 10, 15, 46, 38, 895, DateTimeKind.Utc).AddTicks(9351),
                            DepartureCity = 0,
                            Description = "Remarks",
                            OriginalPrice = 0m,
                            Rating = 3.0,
